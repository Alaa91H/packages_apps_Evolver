...
declare -A EXPECTED=(
    ...
    ["packages/SystemUI/src/com/android/systemui/axdynamicbar/domain/AxDynamicBarInteractor.kt"]="a0edf6eaf638a0d11f2cb914992b94af7537319f"
    ["packages/SystemUI/src/com/android/systemui/axdynamicbar/data/source/SystemIslandManager.kt"]="1cdfe9c1c249d2d105289af105ac8e97480e48c0"
