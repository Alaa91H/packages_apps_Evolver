...
public final class MusicProgressTracker {
    ...
    private static final long UPDATE_INTERVAL_MS = 33L; // ~30 Hz is smooth and avoids 120 Hz invalidation
    ...
    private void scheduleFrame() {
        if (!mFrameScheduled && mIsPlaying && mDurationMs > 0) {
            ...
            mMainHandler.postDelayed(mProgressTick, UPDATE_INTERVAL_MS);
        }
    }
